        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <form id="hukumForm" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
                    <div>
                        <p class="text-xs text-gray-600 font-medium">Dibuat oleh</p>
                        <p class="text-sm font-semibold text-gray-900">{{ $hukum->pemilik }}</p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-600 font-medium">Tanggal Dibuat</p>
                        <p class="text-sm font-semibold text-gray-900">{{ $hukum->created->format('d M Y H:i') }}</p>
                    </div>
                </div>
